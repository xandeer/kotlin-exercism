...
class BoardTest {
  ...
  @Test fun `per square - 1`() = assertGrainsEqual(1, 1)

  @Test fun `per square - 2`() = assertGrainsEqual(2, 2)

  @Test fun `per square - 3`() = assertGrainsEqual(3, 4)

  @Test fun `per square - 4`() = assertGrainsEqual(4, 8)

  @Test fun `per square - 16`() = assertGrainsEqual(16, 32768)

  @Test fun `per square - 32`() = assertGrainsEqual(32, 2147483648)

  @Test fun `per square - 64`() = assertGrainsEqual(64, "9223372036854775808")
